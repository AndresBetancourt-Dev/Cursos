...
function newPerson(name, age, country) {
  ...
  var name = name || "Andres"; //Or Operator to define an alternative value
  var age = age || 20;
...
//Function Call
newPerson(); //Returns my attributes
newPerson("Maria", 17, "México"); //Returns the person with the specified paramethers
//ES6
...
function newPersonECS(name = "NoName", age = 0, country = "Colombia") {
  console.log(name, age, country); //Default paramethers can be defined within the function call
}
//Function Call
newPersonECS();
...
console.log(
  `The type of globalScope it's now ${typeof globalScope} and it's value it's ${globalScope}`
);
